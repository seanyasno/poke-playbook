...
export const LargeGoogleIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
    ...
    >
      <g transform="translate(4636.413 -2865.209)">
        ...
        >
          <stop offset="0" stopColor="#196eef" />
          <stop offset=".5" stopColor="#186dee" />
          <stop offset="1" stopColor="#1065e7" />
        </linearGradient>
        <path
        ...
        <linearGradient
          ...
          gradientTransform="matrix(1.3509 0 0 -1.3509 10917.478 3681.026)"
        >
          <stop offset="0" stopColor="#de5744" />
          <stop offset=".5" stopColor="#db4632" />
          <stop offset="1" stopColor="#d13d29" />
        </linearGradient>
        <path
        ...
        <linearGradient
          ...
          gradientTransform="matrix(1.3509 0 0 -1.3509 10917.478 3681.026)"
        >
          <stop offset="0" stopColor="#1a6fef" />
          <stop offset=".25" stopColor="#1e72ef" />
          <stop offset=".5" stopColor="#166bec" />
          <stop offset=".75" stopColor="#1267e9" />
          <stop offset="1" stopColor="#1063e5" stopOpacity=".87" />
        </linearGradient>
        <path
        ...
        <linearGradient
          ...
          gradientTransform="matrix(1.3509 0 0 -1.3509 10917.478 3681.026)"
        >
          <stop offset="0" stopColor="#0aa561" />
          <stop offset=".5" stopColor="#009b58" />
          <stop offset="1" stopColor="#00914b" />
        </linearGradient>
        <path
        ...
        <linearGradient
          ...
          gradientTransform="matrix(1.3509 0 0 -1.3509 10917.478 3681.026)"
        >
          <stop offset="0" stopColor="#de5644" />
          <stop offset=".5" stopColor="#da4531" />
          <stop offset="1" stopColor="#ce3a28" />
        </linearGradient>
        <path
        ...
        <linearGradient
          ...
          gradientTransform="matrix(1.3509 0 0 -1.3509 10917.478 3681.026)"
        >
          <stop offset="0" stopColor="#ffc01a" />
          <stop offset=".5" stopColor="#ffba03" />
